...
export const HomePageDummyBrowser = () => {
  ...
  return (
    <section className="h-[700px] md:h-[500px] lg:h-auto flex-grow rounded-xl overflow-hidden border-t border-x border-y border-gray-700 flex flex-col flex-shrink-0 lg:w-1/2">
